...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo">
                <?php /* <a href="https://codeigniter.com" target="_blank">
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang Pak Samsi</h1>

        <h2>Pekerjaanmu dalam satu genggaman</h2>
...
<section>
    ...
    <h1>Sistem Informasi Staff DH</h1>

    <p>Halaman ini kamu buat agar lebih produktif, efektif dan fleksibel</p>

    <p>Yang harus kamu menage</p>

    <pre><code>database keuangan DH</code></pre>
    <pre><code>database koperasi DH</code></pre>
