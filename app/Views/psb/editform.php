    ...
    <div class="col-lg-12 d-flex align-items-stretch">
      <div class="card w-100">
        <div class="card-body p-4">
          <div class="mb-3">
            <h3 class="card-title fw-semibold">Edit Data Santri Baru</h3>
            <form action="fulleditform" method="post">
              <?= csrf_field(); ?>
              <?php foreach ($datadiri as $data) : ?>
                <div class="row">
                  ...
                  <div class="mb-0 col-lg-12">
                    ...
                    <input type="text" class="form-control" id="jenjang" name="jenjang" value="<?= $data['jenjang']; ?>">
